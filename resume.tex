...
\resumeItem{Relevant Coursework: Data Structures and Algorithms, Programming Fundamentals, Object-Oriented Programming, Web Development, Artificial Intelligence, Databases, Visual Programming, Mathematics (Linear Algebra, Derivatives, and Integration), Statistics, Cloud Computing, Internet of Things.}
\resumeItemListEnd
\resumeSubHeadingListEnd
%
...
{\textbf{BlockWhere} $|$ \href{https://github.com/inamprograms/BlockWhere}{\underline{[GitHub Link]}}}{}
\resumeItemListStart
\resumeItem{\href{https://www.linkedin.com/feed/update/urn:li:activity:7273650181005336576/}{\underline{Project}} is developed with team with an aim of providing crypto education easy for begginners. It creates the post for different platforms about the given topic related to the crypto. I contributed to project as development team lead, creating backend, integrating AI agents, figuring out problems related to RAG or integration and collaborated with other team members.}
\resumeItemListEnd

\resumeProjectHeading
{\textbf{Teapon} $|$ \href{https://github.com/inamprograms/Teepon}{\underline{[GitHub Link]}}}{}
\resumeItemListStart
\resumeItem{Developed \href{https://www.linkedin.com/feed/update/urn:li:activity:7219377910049103872/}{\underline{Project}} in Hackathon organized by lablab.ai I contributed to the team as software engineer most particular added my contribution in backend, AI, deployment of backend, collaboration with other team members.}
\resumeItemListEnd

\resumeProjectHeading
{\textbf{EcoFactor} $|$ \href{https://github.com/inamprograms/EcoFactory}{\underline{[GitHub Link]}}}{}
\resumeItemListStart
\resumeItem{Developed \href{https://www.linkedin.com/feed/update/urn:li:activity:7188037677848346624/}{\underline{Project}} in Hackathon organized by lablab.ai and scaling it towards startup. I contributed to the team as co founder and Software Engineer.}
\resumeItemListEnd
